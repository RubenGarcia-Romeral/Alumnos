<%-- 
    Document   : Alumnos
    Created on : 5 feb. 2021, 11:09:26
    Author     : Ruben
--%>
        ...
        <div class="container">
            <div class="row">
                ...
                <div>
                    ...
                    <h2 style="font-family: Arial; color: #00ffff">Grupo de DAW Seleccionadao <%=grupoSeleccionado%> </h2>
                    ...
                    <form method="get" action="AlumnosServlet">
                        ...
                        <input class="brn btn-primary" type="submit" value="Elegir" style=" border-radius: 10px; background-color: red; border-color: green;">
                    </form>
            ...
            <div class="row">
                ...
                <div class="col-mb">
                    ...
                    <form action="AlumnosServlet" method="post">
                        ...
                        <label>Has seleccionado el grupo: </label><input type="text" readonly name="grupo" value="<%=grupoSeleccionado%>" class="form-control">
                        ...
                        <input class="brn btn-primary" type="submit" value="Enviar mensaje a alumnos seleccionados" style="background-color: red; border-radius: 10px; border-color: green;">
                    </form>
